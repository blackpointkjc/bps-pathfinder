      ...
      <div className="mx-auto max-w-6xl space-y-4">
        <div className="flex flex-col gap-3 rounded-2xl border border-[#29445f] bg-[#0b1725] p-4 shadow-xl md:flex-row md:items-center md:justify-between">
          <div className="flex-1">
            <div className="text-[9px] font-black uppercase tracking-[.18em] text-amber-300">Virginia Enforcement</div>
            <h1 className="mt-1 text-xl font-black text-white sm:text-2xl">VA Trespass Notices</h1>
            <p className="mt-1 text-xs text-slate-400">Issue, document, and track Virginia trespass notices and service history.</p>
          </div>
          <Button
            onClick={() => {
              resetForm();
