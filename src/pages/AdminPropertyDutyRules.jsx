...
export default function AdminPropertyDutyRules() {
  ...
  return <div className="bps-command-page min-h-0 bg-[#07111d] p-3 text-white md:p-4"><div className="mx-auto max-w-7xl space-y-3">
    <section className="rounded-xl border border-slate-700 bg-[#0a1623] p-3 shadow-lg"><div className="flex items-center gap-3"><div className="flex h-9 w-9 items-center justify-center rounded-lg border border-cyan-500/30 bg-cyan-500/10"><Settings2 className="h-4 w-4 text-cyan-300"/></div><div><div className="text-[9px] font-black uppercase tracking-[.16em] text-cyan-300">Patrol Standards</div><h2 className="mt-0.5 text-lg font-black">Property Duty Rules</h2><p className="mt-1 text-[11px] text-slate-400">DAR, incident-report, and QR compliance requirements by property.</p></div></div></section>
