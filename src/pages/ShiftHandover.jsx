...
export default function ShiftHandover(){
  ...
  return <div className="min-h-full bg-[#07111d] p-3 text-slate-100 md:p-5"><div className="mx-auto max-w-6xl space-y-4">
    <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-[#29445f] bg-[#0b1725] p-4 shadow-xl"><div className="flex items-center gap-3"><div className="flex h-11 w-11 items-center justify-center rounded-xl border border-blue-500/30 bg-blue-500/10"><ArrowRightLeft className="h-5 w-5 text-blue-300"/></div><div><div className="text-[9px] font-black uppercase tracking-[.18em] text-blue-300">Shift Continuity</div><h1 className="mt-1 text-xl font-black text-white sm:text-2xl">Shift Handover</h1><p className="mt-1 text-xs text-slate-400">Pass site conditions, pending work, and equipment status to the next officer.</p></div></div><Button className="bg-blue-600 text-white hover:bg-blue-500" onClick={()=>setShowForm(!showForm)}><Plus className="mr-2 h-4 w-4"/>New Handover</Button></div>
