...
export default function VAContactSheet(){
 ...
 const staff=useMemo(()=>users.filter(u=>!u.termination_date&&!operational.some(o=>o.id===u.id)&&(has(u,'hr')||has(u,'support_staff')||has(u,'company_staff'))).sort((a,b)=>String(a.last_name||'').localeCompare(String(b.last_name||''))),[users,operational]);
