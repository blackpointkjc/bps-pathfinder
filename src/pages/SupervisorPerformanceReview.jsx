...
import { ClipboardCheck, Printer, Star, Award, AlertTriangle, CheckCircle, User } from "lucide-react";
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="metrics-grid">
          ...
          <div class="metric-box">
            <div class="metric-value">${review.on_time_percentage || 100}%</div>
          ...
          <Card className="border-none shadow-xl">
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="p-4 bg-slate-50 rounded-lg border text-center">
                  <p className="text-2xl font-bold text-slate-900">{selectedReview.on_time_percentage || 100}%</p>
