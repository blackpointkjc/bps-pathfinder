    ...
    <div className="bps-command-page min-h-screen bg-[#080d16] p-4 text-white md:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="rounded-[28px] border border-slate-700/80 bg-[#0d1420] p-5 shadow-2xl md:p-7">
          <div className="flex items-center gap-3"><Target className="h-8 w-8 text-cyan-300"/><div><div className="text-[11px] font-black uppercase tracking-[.24em] text-cyan-300">Geofence Command</div><h1 className="mt-1 text-3xl font-black">Geofence Alerts</h1><p className="mt-1 text-sm text-slate-400">Monitor officers leaving assigned patrol zones. Automatic Dispatch is configured separately under Sites & Assets → Automatic Dispatch.</p></div></div>
        </section>
