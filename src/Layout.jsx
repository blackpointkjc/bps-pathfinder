...
import TeamsSyncMonitor from '@/components/TeamsSyncMonitor';
...
export default function Layout({ children, currentPageName }) {
  ...
  return <MicrosoftMailSetupGate user={user}><div className="fixed inset-0 flex overflow-hidden bg-[#050a12] text-white cad-app"><BackgroundLocationTracker user={user} /><NotificationMonitor user={user} /><OutlookNotificationMonitor user={user} /><TeamsSyncMonitor user={user} /><GlobalMessageBanner user={user} /><WelcomeBriefing user={user} /><MandatoryReadGate user={user} /><ForcedOOSOverlay />
