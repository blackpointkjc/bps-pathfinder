...
const DropdownMenuContent = React.forwardRef(({ className, sideOffset = 4, collisionPadding = { top: 8, bottom: 80, left: 8, right: 8 }, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[2147483000] min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-popover-foreground shadow-md pointer-events-auto",
