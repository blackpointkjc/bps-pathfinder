        ...
        html: `
            <div style="position: relative; width: 36px; height: 36px; transform: rotate(${heading || 0}deg);">
                <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" style="filter: drop-shadow(0 2px 6px rgba(0,0,0,0.3));">
                    ...
                    <rect x="6" y="11" width="3" height="2" fill="white" opacity="0.7" rx="0.5"/>
                    <rect x="11" y="11" width="3" height="2" fill="white" opacity="0.7" rx="0.5"/>
                    <polygon points="12,2 14,6 10,6" fill="${color}" stroke="white" stroke-width="0.5"/>
                </svg>
            </div>
        `,
        iconSize: [36, 36],
