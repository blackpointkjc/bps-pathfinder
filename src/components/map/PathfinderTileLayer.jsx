...
const PROVIDERS = {
  // Production maps must never use OpenStreetMap's volunteer tile servers
  // directly. Pathfinder already has a keyed CARTO raster provider; keep that
  // as the primary street/night source and use Esri only as a resilient fallback.
  street: [
    { id: 'carto-voyager-keyed', url: cartoRasterUrl('rastertiles/voyager/{z}/{x}/{y}{r}.png'), attribution: '&copy; OpenStreetMap &copy; CARTO', subdomains: 'abcd' },
  ...
  night: [
    { id: 'carto-dark-keyed', url: cartoRasterUrl('dark_all/{z}/{x}/{y}{r}.png'), attribution: '&copy; OpenStreetMap &copy; CARTO', subdomains: 'abcd' },
  ...
  satellite: [
    ...
    { id: 'carto-voyager-keyed-fallback', url: cartoRasterUrl('rastertiles/voyager/{z}/{x}/{y}{r}.png'), attribution: '&copy; OpenStreetMap &copy; CARTO', subdomains: 'abcd' },
  ],
};
