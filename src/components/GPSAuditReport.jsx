    ...
    <article className="gps-audit" ref={reportRef}>
      ...
      <div className="gps-body">
        ...
        {route?<div className="gps-map" aria-label="Recorded GPS route map">
          ...
          </svg><span className="gps-attribution">© OpenStreetMap © CARTO</span>
