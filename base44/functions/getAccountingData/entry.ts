...
Deno.serve(async (req) => {
  try {
    ...
    const [users, timeEntries, payrollEntries, configs, periods, invoices, locations, expenseReports, companyExpenses, timeOffRequests, ptoUsage, w2Forms, schedules] = await Promise.all([
