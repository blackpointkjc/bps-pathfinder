...
Deno.serve(async (req) => {
  try {
    ...
    const [users, timeEntries, payrollEntries, configs, periods, invoices, locations, expenseReports, companyExpenses, timeOffRequests, w2Forms, schedules] = await Promise.all([
    ...
    return Response.json({
      ...
      timeOffRequests: timeOffRequests || [], w2Forms: w2Forms || [], schedules: schedules || [],
    });
  } catch (error) {
