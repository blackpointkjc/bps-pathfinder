...
export async function buildPerformanceMetrics(base44: any, officer: any, start: string, end: string, metricData: any = null) {
  ...
  // Suggested review fields may still show a neutral 3/5 to a human reviewer, but
  // the company ranking must use only metrics backed by actual records. No hard-coded
  // communication score or invented 75/80 baseline contributes to performance.
